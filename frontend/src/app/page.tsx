  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-foreground">
      <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen text-center">
        ...
        <h1 className="text-5xl font-bold mb-4 text-gray-800 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-200">
          Kenya One Bookshop
        </h1>
        
        <p className="text-xl text-black-600 mb-12 max-w-2xl">
